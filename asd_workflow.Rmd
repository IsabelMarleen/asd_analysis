...
celltypes_louv <- case_when(
  ...
  celltypes_louv == 7  ~ "IN_PV",
  celltypes_louv == 12 ~ "IN_SV2C",
  celltypes_louv == 13 ~ "Microglia",
  celltypes_louv == 14 ~ "IN_VIP",
  celltypes_louv == 21 ~ "neurons_NRGN",
  celltypes_louv == 23 ~ "IN_SST",
  # clusters we merge:
  celltypes_louv %in% c(5, 6, 8, 1, 10, 20, 2, 16) ~ "Neuron_excit",
  celltypes_louv %in% c(11, 15, 19) ~ "Astrocyte",
  celltypes_louv %in% c(3, 9, 18) ~ "OPC",
  celltypes_louv %in% c(22, 17) ~ "Endo_and_pericyte",
...
# 
# 
# save(list = c("cl_louvain", "celltypes_louv", "nn_cells", "nn_inothercluster"),
